...
<div class="contactDetails">
    ...
    <form>
        ...
        <span id="spinner" style="display:none;"><img src="${contextPath}/images/spinner.gif"/></span>
    </form>
    ...
    <div id="directory-help-refine" style="display:none;">
        <p>
            The first 10 are displayed. To refine your search, try entering more details (e.g.
    ...
    <div id="directory-help">
        ...
        <p>
            ...
            <a href="https://www.bris.ac.uk/contact/home">Contact Directory</a> (not optimised for
            mobiles).
        </p>
    </div>
